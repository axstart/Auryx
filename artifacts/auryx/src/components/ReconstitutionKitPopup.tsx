          ...
          <div className="p-5 sm:p-6 pb-[max(1.25rem,env(safe-area-inset-bottom))]">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <DialogTitle className="text-white text-sm font-medium font-['DM_Sans']">{copy.title}</DialogTitle>
                  <DialogDescription className="text-[#C9A844] text-[10px] tracking-wider uppercase font-['DM_Sans'] mt-0.5">
                    {copy.subtitle}
                  </DialogDescription>
                </div>
              </div>
            ...
            <p className="text-white/60 text-[13px] leading-relaxed font-['DM_Sans'] mb-5">{copy.body}</p>
